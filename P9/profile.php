	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		...
		<div class="collapse navbar-collapse" id="collapse">
			<ul class="nav navbar-nav">
				...
				<li style="top:10px;left:20px;"><button class="btn btn-primary" id="search_btn">Busqueda</button></li>
			</ul>
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span><?php echo "Hola, ".$_SESSION["name"]; ?></a>
					<ul class="dropdown-menu">
						...
						<li class="divider"></li>
						<li><a href="" style="text-decoration:none; color:blue;">Cambiar Password</a></li>
						<li class="divider"></li>
		...
		<div class="row">
			...
			<div class="col-md-8">	
				...
				<div class="panel panel-info" id="scroll">
					...
					<div class="panel-footer">&copy;Fp Jesuïtes Uoc 2018</div>
				</div>
			</div>
			<div class="col-md-1"></div>
		</div>
