			...
			<div class="col-md-8">
				<div class="panel panel-primary">
					...
					<form id="signup_form" onsubmit="return false">
						...
						<div class="row">
							<div class="col-md-12">
								<label for="address2">Datos de pago: Nº de tarjeta / Código seguridad</label>
						...
						<div class="row">
							<div class="col-md-12">
								<input style="width:100%;" value="Registrar" type="submit" name="signup_button" onclick="cart.php" class="btn btn-success btn-lg">
							</div>
						</div>
